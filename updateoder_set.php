   ...
   <input type="checkbox" id="menu-toggle">
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="updateoder_set.php" class="active">
                            <span class="las la-edit"></span>
    ...
    <div class="main-content">
        ...
        <main>
                <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        <div class="add">
                            <span>Update Oders Set Menu</span>
                        </div>
                    </div>
        </main>
        <div>
        ...
        <section class="add_menu">
            <h1 class="heading">Add Set Menu</h1>
            <form action="updateoder_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="add_menu_btn"><input type="submit" value="Add Menu" class="btn3 primary-btn3" name="add_menus"></div>
            </form>
        </section>
            ...
            <div class="box-container">
                <?php
                    ...
                    <div class="menuadd_btn">
                        <a href="updateoder_set_edit.php?updates=<?= $fetch_menu['id2']; ?>" class="btn4 primary-btn4">update</a>
                        <a href="updateoder_db.php?deletes=<?= $fetch_menu['id2']; ?>" class="btn5 primary-btn5" onclick="return confirm('delete this menu?');">delete</a>
                    </div>
                    </div>
                    <?php
                        }
