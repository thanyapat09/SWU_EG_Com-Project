...
<body>
    ...
    <section id="page_title">
        <div class="container">
            <h2 class="page_title_text">Oder now!</h2>
        </div>
                        ...
                        ?>
                            <div class="disGrid_item">
                                ...
                                <div class="disGrid_item_info">
                                        <form action="addtocard_db.php" method="POST">
                        ...
                        <div class="container">
                                <div class="name"> MY CART</div>
                                        <?php
                                            $grand_total = 0;
                                            $cart_item[] = '';
                                            $select_cart = $con->prepare("SELECT * FROM cart");
                                            $select_cart->execute();
                                                ...
                                                <div class="disGrid_wrap">
                                                    <div class="disGrid_item">
                                                        ...
                                                        <div class="disGrid_item_info">
                                                            ...
                                                            <input type="submit" name="editcart" class="btn10 primary-btn10" value="Edit Cart">
                                                            </form>
                                                            <div class="delete_icon"><a href="addtocard_db.php?deletecart=<?= $fetch_cart['id']; ?>"><button class="remove"><i class="las la-trash-alt"></i></button></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                                            ...
                                            ?>
                                                <div class="disGrid_wrap">
                                                    <div class="disGrid_item_info">
                                                        <form action="oderconfirm_db.php" method="POST">
                                                        <input type="hidden" name="user_id" value="1">
                                                        <input type="hidden" name="total_price" value="<?= $grand_total; ?>">
                                                        <input type="hidden" name="total_oders" value="<?= $total_oders; ?>">
                                                        <h3 class="disGrid_item_price2">TOTAL PRICE : <?= $grand_total ;?>฿</h3>
                                                        <div class="inputname"><input type="text" placeholder="Please enter name same booking" class="box" name="namebook" required></div>
                                                        <input type="submit" name="oder_con"  class="btn primary-btn" value ="order confirmation">
                                                        </form>
                                                    </div>
                                            <?php
                                            }
