...
<body>
    ...
    <section id="page_title">
        <div class="container">
            <h2 class="page_title_text">Table 1</h2>
        </div>
                            ...
                            <div class="disGrid_item">
                                ...
                                <div class="disGrid_item_info">
                                        <form action="addtocart_table_db.php" method="POST">
                                            ...
                                            <input type="submit" class="add" name="addtocart1" value ="Add to Cart">
                        ...
                        <div class="container">
                                <div class="name"> MY CART</div>
                                        <?php
                                            $grand_total = 0;
                                            $cart_item[] = '';
                                            $select_cart = $con->prepare("SELECT * FROM cart1");
                                            $select_cart->execute();
                                                ...
                                                <div class="disGrid_wrap">
                                                    <div class="disGrid_item">
                                                        ...
                                                        <div class="disGrid_item_info">
                                                            ...
                                                            <input type="submit" name="editcart1" class="btn10 primary-btn10" value="Edit Cart">
                                                            </form>
                                                            <div class="delete_icon"><a href="addtocard_db.php?deletecart1=<?= $fetch_cart['id']; ?>"><button class="remove"><i class="las la-trash-alt"></i></button></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                                            ...
                                            ?>
                                                <div class="disGrid_wrap">
                                                    <div class="disGrid_item_info">
                                                        ...
                                                        <div class="inputname"><input type="hidden" class="box" value="Table1" name="namebook"></div>
                                                        <input type="submit" name="oder_con1"  class="btn primary-btn" value ="order confirmation">
                                                        </form>
                                                    </div>
                                            <?php
                                            }
