   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <section class="add_menu">
            <h1 class="heading">Add Miscellaneous Menu</h1>
            <form action="updateoder_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="add_menu_btn"><input type="submit" value="Add Menu" class="btn3 primary-btn3" name="add_menum"></div>
            </form>
        </section>
            ...
            <div class="box-container">
                <?php
                    ...
                    <div class="menuadd_btn">
                        <a href="updateoder_mis_edit.php?updatem=<?= $fetch_menu['id4']; ?>" class="btn4 primary-btn4">update</a>
                        <a href="updateoder_db.php?deletem=<?= $fetch_menu['id4']; ?>" class="btn5 primary-btn5" onclick="return confirm('delete this menu?');">delete</a>
                    </div>
                    </div>
                    <?php
                        }
