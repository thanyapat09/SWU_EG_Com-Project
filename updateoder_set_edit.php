   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <section class="updatemenu">
            ...
            <h1 class="heading">Update Set Menu</h1>

                <?php
                    $update_id = $_GET['updates'];
                    $select_products = $con->prepare("SELECT * FROM updatemenu_set WHERE id2 = ?");
                    $select_products->execute([$update_id]);
                    if($select_products->rowCount() > 0){
                        while($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)){ 
                ?>
                <form action="updateoder_edit_db.php" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="pid" value="<?= $fetch_products['id2']; ?>">
                    ...
                    <div class="menuadd_btn">
                        <input type="submit" value="update Menu" class="btn6 primary-btn6" name="update_menus">
                        <a href="updateoder_set.php" class="btn7 primary-btn7">go back</a>
                    </div>
                </form>
