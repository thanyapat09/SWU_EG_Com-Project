   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <section class="updatemenu">
            ...
            <h1 class="heading">Update Appetizers</h1>

                <?php
                    $update_id = $_GET['updatea'];
                    $select_products = $con->prepare("SELECT * FROM updatemenu_app WHERE id3 = ?");
                    $select_products->execute([$update_id]);
                    if($select_products->rowCount() > 0){
                        while($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)){ 
                ?>
                <form action="updateoder_edit_db.php" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="pid" value="<?= $fetch_products['id3']; ?>">
                    ...
                    <div class="menuadd_btn">
                        <input type="submit" value="update Menu" class="btn6 primary-btn6" name="update_menua">
                        <a href="updateoder_app.php" class="btn7 primary-btn7">go back</a>
                    </div>
                </form>
