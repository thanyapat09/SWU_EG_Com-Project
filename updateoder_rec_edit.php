   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <section class="updatemenu">
            ...
            <h1 class="heading">Update Recommended Menu</h1>

                <?php
                    $update_id = $_GET['updater'];
                    $select_products = $con->prepare("SELECT * FROM updatemenu_recom WHERE id = ?");
                ...
                <form action="updateoder_edit_db.php" enctype="multipart/form-data" method="post">
                    ...
                    <div class="menuadd_btn">
                        <input type="submit" value="update Menu" class="btn6 primary-btn6" name="update_menur">
                        <a href="updateoder_rec.php" class="btn7 primary-btn7">go back</a>
                    </div>
                </form>
