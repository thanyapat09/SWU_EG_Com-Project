   ...
   <input type="checkbox" id="menu-toggle">
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="updateoder_app.php" class="active">
                            <span class="las la-edit"></span>
    ...
    <div class="main-content">
        ...
        <main>
                <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        <div class="add">
                            <span>Update Oders Appetizers</span>
                        </div>
                    </div>
        </main>
        <div>
        ...
        <section class="add_menu">
            <h1 class="heading">Add Appetizers Menu</h1>
            <form action="updateoder_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="add_menu_btn"><input type="submit" value="Add Menu" class="btn3 primary-btn3" name="add_menua"></div>
            </form>
        </section>
            ...
            <div class="box-container">
                <?php
                    ...
                    <div class="menuadd_btn">
                        <a href="updateoder_app_edit.php?updatea=<?= $fetch_menu['id3']; ?>" class="btn4 primary-btn4">update</a>
                        <a href="updateoder_db.php?deletea=<?= $fetch_menu['id3']; ?>" class="btn5 primary-btn5" onclick="return confirm('delete this menu?');">delete</a>
                    </div>
                    </div>
                    <?php
                        }
